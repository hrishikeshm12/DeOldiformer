...
if __name__ == "__main__":
    ...
    restored_images_folder = "./resized_codeformer_results_w/resized_codeformer_results_w_0.3/"  # Specify the exact folder you want to process

    # Compute cosine similarity for the specified folder
